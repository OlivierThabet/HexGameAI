...
def _get_geom(n: int) -> dict:
    ...
    # Gradient linéaire précalculé pour x0 du CG
...
class MyPlayer(PlayerHex):
    ...
    def _calculate_amperage(self, board_key: Tuple[str, ...], target_piece: str, geom: dict) -> float:
        ...
        # Construction avec matrice creuse LIL (insertions rapides)
        ...
        # Conversion LIL -> CSR pour le solveur (multiplication matrice-vecteur rapide)
        g_csr = g_mat.tocsr()

        # Estimation initiale x0 : gradient linéaire ou dernière solution connue
        ...
        try:
            ...
            # Sauvegarder la solution pour la réutiliser comme x0 au prochain appel
