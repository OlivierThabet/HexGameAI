...
- Early/mid game (beaucoup de cases vides) : greedy one-ply (amperage)
- Late game (peu de cases vides, < 50%) : MiniMax iterative deepening
...
class MyPlayer(PlayerHex):
    ...
    def compute_action(
        ...
        **kwargs,
        ...
        # --- Choix de l'algorithme : heuristique si > 50% vide, minimax sinon ---
        ...
        if half_full:
            ...
            return self._greedy_search(board, playable, my_piece, geom, n)

    # -----------------------------------------------------------------------
    # Greedy one-ply (early/mid game)
    # -----------------------------------------------------------------------

    def _greedy_search(self, board, empties, my_piece, geom, n):
